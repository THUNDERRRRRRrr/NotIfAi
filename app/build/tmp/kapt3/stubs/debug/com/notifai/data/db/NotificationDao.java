...
public abstract interface NotificationDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM notifications ORDER BY timestamp DESC LIMIT :limit")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.notifai.data.model.NotificationEntity>> getRecentNotifications(int limit);
